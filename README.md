...
wallpaper.start_watcher(std::time::Duration::from_millis(100))?;
...
""ferris.rs"" (examples/ferris.rs)| Native rendering with Macroquad, desktop attachment, and interactive mouse input
""keyboard.rs"" (examples/keyboard.rs)| Interactive WebView content with Wry/Tao, desktop attachment, and forwarded mouse input
""neonvillage.rs"" (examples/neonvillage.rs)| A large WebView/Three.js-style animated scene running as an interactive desktop background
""strings.rs"" (examples/strings.rs)| A WebView animation attached to the desktop
""wormhole.rs"" (examples/wormhole.rs)| A WebView-based animated black-hole scene attached to the desktop
