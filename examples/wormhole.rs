/// The webview piece inspired by Wormhole project on codepen.io/wodniack/pen/XJbYWXx and
/// modified by ai also other parts are generated by ai and modified by me to work with wallopino
///
/// See line 39 to 41 to see how forwarding and attaching happends
///
///
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Create attacher object we dont need forwarder here it the project doesn't act to events
